...
\033[1;91m-----------------------------------------------
\033[1;92m➣ OWNER   : HACKER BOSS
\033[1;92m➣ Github  : https://github.com/muskanckg
\033[1;92m➣ GANG    : PMG 420 GING OF FB
\033[1;92m➣ Youtube : 
\033[1;92m➣ WhatsApp: 3155538375
\033[1;91m-----------------------------------------------"""
# titik #
def tik():
	titik = [".   ","..  ","... "]
...
def login():
	...
	try:
		...
		os.system("clear")
		print (banner)
		Shan Noor('[!] Hacker Boss')
		Shan Noor('[!] Use a New Facebook Account To Login')
		print'-------------------------------------'
